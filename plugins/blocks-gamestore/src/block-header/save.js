		...
		<div {...useBlockProps.save()}>
			<div className="inner-header">
				...
				<div className="right-section">
					<button type="button" className="header-search" aria-label="Поиск">
						<svg
							width="36"
							height="36"
							viewBox="0 0 36 36"
					...
					{cartLink && (
						<a href={cartLink} className="header-cart-link">
							<svg
								width="36"
								height="36"
								viewBox="0 0 36 36"
					...
					{memberLink && (
						<a href={memberLink} className="header-member-link">
							Личный кабинет
						</a>
					)}
					<button type="button" className="header-toggle-menu" aria-label="Мобильное меню">
						<svg
							width="36"
							height="36"
							viewBox="0 0 36 36"
